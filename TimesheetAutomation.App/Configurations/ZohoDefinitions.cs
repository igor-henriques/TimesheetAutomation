...
internal record ZohoDefinitions
{
    ...
    private ZohoDefinitions() { }

    public static async Task<ZohoDefinitions> GetInstanceAsync()
    {
        var definitions = JsonConvert.DeserializeObject<ZohoDefinitions>(await File.ReadAllTextAsync("./Configurations/Definitions.json"));
